...
func (b GCS) Upload(ctx context.Context, localPath string, t Target, object string, overwrite bool) error {
	if !overwrite {
		_, exists, err := gcs.Describe(ctx, b.Run, b.gcsTarget(t), object)
		if err != nil {
			return err
		}
		if exists {
	...
	return gcs.Upload(ctx, b.Run, localPath, b.gcsTarget(t), object)
}

func (b GCS) Download(ctx context.Context, t Target, object, destPath string) error {
	return gcs.Download(ctx, b.Run, b.gcsTarget(t), object, destPath)
}

func (b GCS) Delete(ctx context.Context, t Target, object string) error {
	return gcs.Delete(ctx, b.Run, b.gcsTarget(t), object)
}
