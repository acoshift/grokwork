...
| `projects.*.repoFetchIntervalMinutes` | Auto `git fetch` throttle before creating a new worktree (default `5`; `0` disables). Editable on the project settings page |
